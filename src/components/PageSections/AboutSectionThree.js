                ...
                <div className="row align-items-end">
                    <div className="col-xl-7 col-lg-7 col-md-6">
                        <div className="section-title">
                            <h2>About <br/> M&Q TradeAxis <span className="d-none d-md-block"><i
                                className="las la-arrow-down ml-40"></i></span></h2>
                        </div>
                        <div className="about-desc mt-60 pl-150">
                            <p>M&Q TradeAxis is a premier woodcarving studio dedicated to creating exceptional handcrafted wooden sculptures and art pieces. With a commitment to preserving traditional techniques while embracing contemporary design, our master carvers transform premium hardwoods into functional and decorative pieces that become treasured heirlooms and valuable collectibles.</p>
                        </div>
                    </div>
