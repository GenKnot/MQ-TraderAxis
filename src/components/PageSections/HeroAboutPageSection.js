        ...
        <div id="about_page" className="hero-area">
            <div className="container">
                ...
                <div className="row mt-30">
                    <p>M&Q TradeAxis was founded in 2010 by Muta, a third-generation woodcarver with a passion for transforming wood into art. What began as a small studio in Beijing has grown into a renowned wood sculpture gallery and workshop.</p>
                    ...
                    <p>Today, M&Q TradeAxis pieces can be found in private collections, corporate headquarters, and galleries across North America, Europe, and Asia.</p>
                </div>
            </div>
        </div>
    )
