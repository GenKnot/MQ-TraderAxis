import slideImage8 from "@/assets/img/slider/slide-8.jpg";
import slideImage9 from "@/assets/img/slider/slide-9.jpg";
import slideImage10 from "@/assets/img/slider/slide-10.jpg";

export const homePageBannersData = [
    {
        id: 1,
        project_name: "Nature Series",
        completed_title: "Master Collection",
        address: "American Black Walnut",
        price: "895",
        theme_style: "Nature Inspired",
        architect: "Master Craftsman",
        image: slideImage8,
    },
    {
        id: 2,
        project_name: "Animal Collection",
        completed_title: "Limited Edition",
        address: "Cherry Wood",
        price: "8,245",
        theme_style: "Wildlife",
        architect: "Senior Artisan",
        image: slideImage9,
    },
    {
        id: 3,
        project_name: "Abstract Series",
        completed_title: "Contemporary Art",
        address: "Maple & Ebony",
        price: "3,595",
        theme_style: "Modern",
...
export const testimonialOneData = [
    ...
    },
    {
        id: 2,
        content:
            "The eagle sculpture I purchased has become the centerpiece of my living room. The detail in the feathers is remarkable, and everyone who visits comments on its beauty and craftsmanship.",
